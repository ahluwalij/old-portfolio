  ...
  return (
    ...
    <div className="w-screen h-[30vh] lg:h-[40vh] relative ">
        <div className="absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh]  z-10">
            <Image className="absolute z-1" layout="fill" objectFit="cover" src={movies} alt="/"/>
        ...
        <div className="col-span-4 p-4 shadow-xl md:col-span-1 rounded-xl">
            <div className="p-2">
                ...
                <div className="grid grid-cols-3 md:grid-cols-1">
                    <p className="flex items-center py-2"><RiRadioButtonFill className="pr-1"/>React</p>
                    <p className="flex items-center py-2"><RiRadioButtonFill className="pr-1"/>JavaScript</p>
                    <p className="flex items-center py-2"><RiRadioButtonFill className="pr-1"/>CSS</p>
                </div>
            </div>
        </div>
        <Link href='/#projects'>
